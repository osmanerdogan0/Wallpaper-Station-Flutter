...
import 'package:wallpaper_station/view/image_view.dart';
...
Widget BrandName(){
  return Row(
    ...
    children: [
      Text('Wallpeper', style: TextStyle(color: Colors.black),),
      Text('Station', style: TextStyle(color: Colors.redAccent),),
    ],
  );
}