...
import 'package:wallpaper_station/model/categories_model.dart';
import 'package:wallpaper_station/model/photos_model.dart';
import 'package:wallpaper_station/view/categories_screen.dart';
import 'package:wallpaper_station/view/search_view.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    GestureDetector(
    onTap: () {
    _launchURL("https://www.linkedin.com/in/osman-erdo%C4%9Fan-6b426912a/");
    },
    child: Container(
    child: Text(
    "Osman Erdoğan ",
